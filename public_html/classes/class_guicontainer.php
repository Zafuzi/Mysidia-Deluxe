    ...
    */
	...
	public function getComponents($GUIComponent){
		...
		while($iterator->hasNext()){
		    ...
		    if($component instanceof $GUIComponent) $components->put(new Str($component->getID()), $component);
		}
		return $components;
	}	
    ...
    protected function getComponentsByType($type){
		...
		while($iterator->hasNext()){
		    $component = $iterator->next();
			if($component instanceof $type) $this->$property->put(new Str($component->getID()), $component);
    ...
    public function __toString(){
	    return new Str("This is The GUIContainer class.");
	}
}
?>