...
class FriendsController extends AppController{
	...
	public function request(){
        ...
        if(!$friend->isfriend){	  
	        if($friend->sendrequest()) $this->setField("friend", new Str($friend->username));
	...
	public function option(){
		...
		$optionsMap->put(new Str("pmoption"), new Integer($options->pmstatus));
		$optionsMap->put(new Str("vmoption"), new Integer($options->vmstatus));
		$optionsMap->put(new Str("tradeoption"), new Integer($options->tradestatus));		
	...
	public function edit(){
	    ...
	    switch($mysidia->input->get("confirm")){
            case "accept":	
                ...
                $this->setField("fromuser", new Str($friendrequest->fromuser));				
	            break;
	        case "decline":
				$friendrequest = new FriendRequest($mysidia->input->get("id"));	
