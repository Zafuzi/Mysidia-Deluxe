...
<link rel="stylesheet" href="' . $path_host . 'freichat/client/jquery/freichat_themes/freichatcss.php" type="text/css"></body>\';
$freichatx_html=str_replace("</body>",$html,$freichatx_html);
echo $freichatx_html;';
