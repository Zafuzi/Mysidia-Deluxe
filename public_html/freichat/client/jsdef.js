...
freidefines = {
    ...
    TRANS: {
        ...
        MAIL: {
            _with: '<?php echo $frei_trans["mail_conv_with"]; ?>',
            type: '<?php echo $frei_trans["mail_conv_type"]; ?>',
            subject: '<?php echo $frei_trans["mail_conv_subject"]; ?>',
            rec: "<?php echo $frei_trans['mail_conv_rec']; ?>",
            send: '<?php echo $frei_trans["mail_conv_send"]; ?>',
            title: '<?php echo $frei_trans["mobile_mail_title"]; ?>',
            lsubject: '<?php echo $frei_trans["mail_label_subject"]; ?>',
            lmail: '<?php echo $frei_trans["mail_label_mail"]; ?>'
        },
        FILE: {
            title: '<?php echo $frei_trans["file_title"]; ?>',
            select: '<?php echo $frei_trans["file_select"]; ?>',
            remove: '<?php echo $frei_trans["file_remove"]; ?>',
    ...
    groupchatimg: '<?php echo $groupchatimg;?>',
    ...
    titles_groupchat: '<?php echo $frei_trans["titles_groupchat"]; ?>',
    ...
    PLUGINS: {
        ...
        showmobilechat: '<?php echo $cvs->show_mobilechat_plugin; ?>',        
